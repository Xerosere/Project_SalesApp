...
class SecondCategory {
  ...
  factory SecondCategory.fromJson(String source) =>
      SecondCategory.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() =>
      'SecondCategory(name_second: $name_second, id_category: $id_category, number_cate: $number_cate)';

  @override
  bool operator ==(covariant SecondCategory other) {
    if (identical(this, other)) return true;

    return other.name_second == name_second &&
  ...
  @override
  int get hashCode =>
      name_second.hashCode ^ id_category.hashCode ^ number_cate.hashCode;
